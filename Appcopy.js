 ...
 */
  ...
  const restrautList = [
    {
      ...
      data: {
        ...
        cityState: "22",
        address:
          "KFC Restaurant, Kondapur 500081",
    ...
    },
    {
      ...
      data: {
        ...
        city: "22",
        area: "Hitec city opposite to cyber tower",
        totalRatingsString: "50+ ratings",
        cloudinaryImageId: "sboh9oor0cvp6ztsyhvj",
        cuisines: ["Biryani", "Chicken", "North Indian", "Snacks", "Beverages"],
        tags: [],
        costForTwo: 30000,
        costForTwoString: "₹300 FOR TWO",
        deliveryTime: 33,
    ...
    },
    {
      ...
      data: {
        ...
        cuisines: ["Sweets", "South Indian", "Thalis", "Fast Food"],
        tags: [],
        costForTwo: 20000,
        ...
        slugs: {
          restaurant: "taza-kitchen-ayyapa-scotiety-100ftroad",
          city: "dehradun",
        },
        cityState: "22",
        address:
          "taza-kitchen-ayyapa-scotiety-100ftroad 500081",
  ...
  const RestaurantCardDynamicFromArray =(({name,cuisines,cloudinaryImageId,lastMileTravelString})=>
    {
        return (
            <div className='res-card'>
                <img
  ...
  const Body= () =>{
    ...
    <div className='body'>
        ...
        <div className='restaurant-list'>
            {restrautList.map((restaraunt)=>{
                return <RestaurantCardDynamicFromArray {...restaraunt.data} key={restaraunt.data.id} />;}
                          )}
        </div>
            </div>
    )
